...
- Space: deliver beer
- R: restart
- Touch devices: use the vertically stacked arrows and circular beer-icon button
...
`../BeerDelivery_v9_beer_icon/`

To restore it, copy that version's files to a new working folder. Do not delete v10.

...
- Space: deliver beer
- R: restart
- Touch devices: use the larger UP, DOWN, and BEER buttons
...
- Starting at Level 4, every served customer returns an empty mug.
...
`../BeerDelivery_v3_controls_layout/`

To restore it, copy that version's files to a new working folder. Do not delete v4.
